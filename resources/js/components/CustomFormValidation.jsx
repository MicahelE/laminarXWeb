...
import hmimg from '/resources/img/hmbg1.png';
const defaultState = {
  name:null,
  email:null,
  password:null,
          ...
          <div class="container-fluid ps-md-0">
              <div class="row g-0">
                <div class="d-none d-md-flex col-md-4 col-lg-6 bg-image" >
                    <div class="csthead text-white text-lg">LAMINAR-X</div>
                </div>
                      ...
                      <div class="row">
                        <div class="col-md-9 col-lg-8 mx-auto">
                          ...
                          <form>
                            ...
                            <span>Username*</span>
                            <label class="mt-5 text-gray-500" for=""></label>
                            ...
                            <div class="form-floating mb-3">
                              ...
                              <input type="password" className={"form-control " + (this.state.passwordError ? 'invalid' : '')} id="floatingPassword" name="password" placeholder="Password" value={this.state.password} onChange={this.handleInputChange} />
                              <label for="floatingPassword">Country of residence</label>
                              <span className="text-danger">{this.state.passwordError}</span>
                            </div>
